# Project Computer Science - run_sharkcount_comp.py
...
# values of the initial shark_count parameter.
...
for sharkcount in [4, 12, 20]:
    ...
    for i in range(runs):
        ...
        sim.simulate(collect_steps * collect_interval, [main.collect_data(collect_range, neighbourdata)],
                     [collect_interval], FOOD_START_COUNT, [FISH_START_COUNT, FISH_START_RADIUS, FISH_START_CHANCE], [], sharkcount)
    ...
    plt.savefig(f"violin-sharkcount={sharkcount}.svg",
