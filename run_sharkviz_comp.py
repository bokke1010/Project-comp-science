# Project Computer Science - run_sharkviz_comp.py
...
# values of the shark vision parameter.
...
for vision in [2, 4, 6]:
    print(f"Simulating with {vision} shark vision per step")

    # Simulate runs.
    sim.shark_vision = vision
    for i in range(runs):
    ...
    plt.savefig(f"violin-sharkvision={vision}.svg",
